/**
 * Adapted from com.codahale.metrics.Slf4jReporter
 */
...
public class Slf4jJsonReporter extends ScheduledReporter {
     ...
     * @return a {@link Builder} instance for a {@link Slf4jJsonReporter}
     */
    ...
    /**
     * A builder for {@link Slf4jJsonReporter} instances. Defaults to logging to {@code metrics}, not
    ...
    public static class Builder {
         ...
         *
         * @param loggingLevel a (@link Slf4jJsonReporter.LoggingLevel}
         * @return {@code this}
         */
        ...
        /**
         * Builds a {@link Slf4jJsonReporter} with the given properties.
         *
         * @return a {@link Slf4jJsonReporter}
         */
